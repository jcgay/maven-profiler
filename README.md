...
Get [maven-profiler](http://dl.bintray.com/jcgay/maven/com/github/jcgay/maven/maven-profiler/0.1/maven-profiler-0.1.jar) and copy it in `%M2_HOME%/lib/ext` folder.
